...
function module.dobluridk(prnt)
	...
	frame.Parent = prnt
	frame.Size = UDim2.new(0.75, 0, 0.5, 0)
	...
	local function UpdateOrientation(fetchProps)
		...
		DrawQuad(
			...
			camera:ScreenPointToRay(br.x, tl.y, zIndex).Origin,
			camera:ScreenPointToRay(tl.x, br.y, zIndex).Origin,
